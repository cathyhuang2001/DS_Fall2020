 ...
 * we need to spend O(n) time to "make room" for the insertion.
 * This implementation is particularly inefficient as it keeps
 * the "best" to the front of the array, so remove() also takes O(n) time</p>
 *
