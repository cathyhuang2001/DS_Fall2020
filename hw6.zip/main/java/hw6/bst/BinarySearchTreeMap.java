...
public class BinarySearchTreeMap<K extends Comparable<K>, V>
  ...
  public Iterator<K> iterator() {
    // This is not a good iterator!
    // It uses O(n) extra time and space to build the iterator.
    // You should instead use iterator for BST implementation of OrderedSet
    //  which was implemented an as iterative in-order traversal.
